...
RRECOMMENDS:${FIPTOOL_WRAPPER}:append:class-nativesdk = " nativesdk-tf-a-tools-fio"
...
FIPTOOL ?= "fiptool"
# Set FIO fiptool wrapper
FIPTOOL_WRAPPER ?= "fiptool-fio"
